...
import "../../src/references/SupplyReference.sol";
contract SupplyReferenceBS {
    ...
    function burn(address _from, uint256 _value) public  startPrank stop  {
        SupplyReference(proxiedContract).burn(_from, _value);
    }

	function mint(address _to, uint256 _value) public  startPrank stop  {
        SupplyReference(proxiedContract).mint(_to, _value);
    }
}
